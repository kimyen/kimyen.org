var dashboard = {
	...
	source: "<button class='btn btn-default'><a href='https://github.com/kimyen/dashboard'>Dashboard</a></button> <button class='btn btn-default'><a href='https://github.com/kimyen/dashboard-ui'>Dashboard UI</a></button>",
...
var campusPath = {
	...
	source: "<button class='btn btn-default'><a href='https://github.com/kimyen/CampusPaths'>Campus Paths</a></button>",
    img: "/img/campuspath.png"
};
...
var bj = {
	...
	technology: "<ul><li>Eclipse</li></ul>",
	source: "<button class='btn btn-default'><a href='https://github.com/kimyen/Java'>Blackjack</a></button>",
    img: "/img/bj.png"
};
